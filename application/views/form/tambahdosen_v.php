...
<div class="col-sm-8">
	<form class="form-horizontal" method="post">
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control" name="npp" id="inputEmail3" value="<?php echo set_value('npp');?>">
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control" name="nama" id="inputPassword3" value="<?php echo set_value('nama');?>">
	  ...
	  <div class="form-group">
		...
		<div class="col-sm-6">
		  <input type="text" class="form-control" name="nohp" id="inputPassword3" value="<?php echo set_value('nohp');?>">
